...
parser.add_argument("--subwords", default=True, action="store_true", help="Use subwords")
...
with strategy.scope():
    ...
    if args.pretrained:
        rnn_transducer.load_weights(args.pretrained, by_name=True, skip_mismatch=True)
